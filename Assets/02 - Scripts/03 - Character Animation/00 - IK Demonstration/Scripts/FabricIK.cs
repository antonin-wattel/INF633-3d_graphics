    ...
    private void Init()
    {
        ...
        for (var i = bones.Length - 1; i >= 0; i--)
        {
            ...
            else
            {
                ...
                // use vector3.magnitude to calculate the distance between them
            ...
            for (int ite = 0; ite < iterations; ite++)
            {
                ...
                for (int i = bonesPositions.Length - 1; i > 0; i--)
                {
                    ...
                    else
                    {
                        ...
                        // bonesPositions[i] = bonesPositions[i + 1] - startingBoneDirectionToNext[i].normalized * bonesLength[i-1];
                    }
                ...
                for (int i = 1; i < bonesPositions.Length; i++)
                {
                    ...
                    //  change the position of the bones towards the root, while keeping the distance between them constant.
                    // compute direction towards the root
